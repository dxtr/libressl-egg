;;;; libressl.scm
;;;; Bindings to the LibreSSL SSL/TLS library
...
(define (ssl-connect hostname #!optional port (ctx 'tls))
	...
	(begin
	  ...
	  (if asn1?
		...
		"return(SSL_CTX_use_certificate_file((SSL_CTX *)ctx, path, SSL_FILETYPE_ASN1));")
	       (ssl-unwrap-context obj) (##sys#expand-home-path pathname/blob))
	      ((foreign-lambda
	...
	(begin
	  ...
	  (if (memq rsa? '(rsa #t))
		...
		"return(SSL_CTX_use_RSAPrivateKey_file((SSL_CTX *)ctx, path, (asn1 ? SSL_FILETYPE_ASN1 : SSL_FILETYPE_PEM)));")
	       (ssl-unwrap-context obj) (##sys#expand-home-path pathname/blob) asn1?)
	      ((foreign-lambda*
		int ((c-pointer ctx) (c-string path) (bool asn1))
